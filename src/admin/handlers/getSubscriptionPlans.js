...
const handler = async (request, reply) => {
    try {
        ...
        const userType=_.get(request,"payload.userType",'');
            ...
            // const data1={planName:"Paid",currencyType:"$",price:"30.00",days:"90",userType:"business",status:"1"}
            // const data={planName:"Free",currencyType:"$",price:"00.00",days:"30",userType:"individual",status:"1"}
            // const obj= await new SubscriptionPlan(data);
            // await obj.save();
            // const obj1= await new SubscriptionPlan(data1);
            // await obj1.save();
...
const routeConfig = {
    method: 'POST',
    path: '/admin/getSubscriptionPlans',
    config: {
        tags: ['api', 'users'],
